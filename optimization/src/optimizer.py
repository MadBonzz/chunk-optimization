...
class ChunkOptimizer:
    def __init__(self, embed_model_path : str, embed_model : Llama = None):
    ...
    def optimize_chunks(self, chunks : list, max_chunk_len : int, min_chunk_len : int, similarity_threshold : float, embeddings : list = None):
        split_embeddings = {}
        ...
        split_embeddings = combine_embeddings(self.embed_model, max_chunk_len, similarity_threshold, split_embeddings, min_chunk_len)
